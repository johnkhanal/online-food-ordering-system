                      ...
                      <form class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                        <div class="form-row">
                          ...
                          <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="validationCustom4" name="i_nickname" placeholder="Enter Food Nickname" required>
                            <div class="valid-feedback"> Looks good! </div>
                          </div>
                        </div> <!-- /.form-row -->
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select class="form-control select2" id="validationSelect2" name="i_r_id" required>
                              ...
                              <?php 
                                $editorr = $pdo->prepare("SELECT * FROM resturants WHERE r_e_id='$eid'");
                                $editorr->execute(); 
                                $editor = $editorr->fetchAll();
                              
                              echo '<optgroup label="Users">';
                              foreach($editor as $editors){
                                echo '<option value="'.$editors['r_id'].'">'.$editors['r_name'].'</option>';
                              }
                                echo '</optgroup>';
                              ?>
                            </select>
