            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="formsDropdown">
                  <a class="nav-link pl-lg-2" href="./resturants"><span class="ml-1">Resturants</span></a>
                  ...
                  <a class="nav-link pl-lg-2" href="./featuredresturants"><span class="ml-1">Featured Resturants</span></a>
                  <a class="nav-link pl-lg-2" href="./editors"><span class="ml-1">Editors</span></a>
                  <a class="nav-link pl-lg-2" href="./orders"><span class="ml-1">Orders</span></a>
                  <a class="nav-link pl-lg-2" href="./feedbacks"><span class="ml-1">Feedback</span></a>
                </div>
              </li>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="ui-elementsDropdown">
                  <a class="nav-link pl-lg-2" href="./addresturant"><span class="ml-1">Add Resturant</span></a>
                  ...
                  <a class="nav-link pl-lg-2" href="./addfeaturedresturant"><span class="ml-1">Add featured resturants</span></a>
                  <a class="nav-link pl-lg-2" href="./addeditor"><span class="ml-1">Add Editor</span></a>
                </div>
              </li>
